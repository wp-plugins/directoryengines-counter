...
class De_Counter
{
    ...
    function register()
    {
        ...
        add_action('wp_insert_post', array(self::getInstance(), 'insert_view_row'));
    }

    public function insert_view_row($post_id = null){
        $viewed_count = $this->increase_view_count($post_id, 0);
    }
